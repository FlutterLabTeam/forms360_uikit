...
class CustomBorder extends CustomPainter {
  ...
  CustomBorder(this.color, this.borderType);
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (borderType == BorderType.DOTTED) {
      drawDottedBorder(canvas, size, paint);
    } else {
      drawDashedBorder(canvas, size, paint, path);
    }
  ...
  void drawDottedBorder(Canvas canvas, Size size, Paint paint) {
  ...
  void drawDashedBorder(Canvas canvas, Size size, Paint paint, Path path) {
